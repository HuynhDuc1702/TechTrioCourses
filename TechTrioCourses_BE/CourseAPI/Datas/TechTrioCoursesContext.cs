...
public partial class TechTrioCoursesContext : DbContext
{
    public TechTrioCoursesContext()
    {
    }

    public TechTrioCoursesContext(DbContextOptions<TechTrioCoursesContext> options)
        : base(options)
    {
    }
