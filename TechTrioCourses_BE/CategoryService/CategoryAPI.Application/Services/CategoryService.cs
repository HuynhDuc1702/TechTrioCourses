...
namespace CategoryAPI.Application.Services
{
    public class CategoryService : ICategoryService

    {
        private readonly ICategoryRepository _coursesRepo;
        private readonly IMapper _mapper;

        public CategoryService(ICategoryRepository coursesRepo, IMapper mapper)
        {
