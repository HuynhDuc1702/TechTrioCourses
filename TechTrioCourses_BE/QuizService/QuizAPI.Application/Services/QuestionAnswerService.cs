...
namespace QuizAPI.Application.Services
{
    ...
    {
        private readonly IQuestionAnswerRepository _questionAnswerRepo;
        private readonly IMapper _mapper;

        public QuestionAnswerService(IQuestionAnswerRepository questionAnswerRepo, IMapper mapper)
        {
