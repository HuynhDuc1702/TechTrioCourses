...
namespace QuizAPI.Application.Services
{
    public class QuizService : IQuizService
    {
        ...
        private readonly IQuizQueryRepository _quizQuery;
        private readonly IQuestionChoiceService _questionChoiceService;
        private readonly IQuestionAnswerService _questionAnswerService;
        private readonly IQuestionService _questionService;

        public QuizService(IQuizRepository quizRepo, IMapper mapper, IQuizQueryRepository quizQuery, IQuestionChoiceService questionChoiceService, IQuestionAnswerService questionAnswerService, IQuestionService questionService
            )
        {
            _quizRepo = quizRepo;
            _mapper = mapper;
